...
$(window).scroll(function () {
    $('.ani').each(function (i) {
        if (isScrolledIntoView(this)) {
            $(this).addClass("animation-edu-4 fadeIn");
        }	
    });
});
$(window).scroll(function () {
    $('.ani-left').each(function (i) {
        if (isScrolledIntoView(this)) {
            $(this).addClass("animation-edu-6 fadeInLeft");
        }	
    });
});
$(window).scroll(function () {
    $('.ani-right').each(function (i) {
        if (isScrolledIntoView(this)) {
            $(this).addClass("animation-edu-8 fadeInLeft");
        }	
    });
});
$(window).scroll(function () {
    $('.ani-title').each(function (i) {
        if (isScrolledIntoView(this)) {
            $(this).addClass("animation bounceInRight ");
        }	
    });
});
$(window).scroll(function () {
    $('.ani-top').each(function (i) {
        if (isScrolledIntoView(this)) {
            $(this).addClass("animation fadeIn-top");
            $(this).addClass("animation fadeIn-top");
        }	
    });
});
$(window).scroll(function () {
    $('.ani-title-left').each(function (i) {
        if (isScrolledIntoView(this)) {
            $(this).addClass("animation bounceInLeft");
        }	
    });
});
$(window).scroll(function () {
    $('.ani-zoom').each(function (i) {
        if (isScrolledIntoView(this)) {
...
$('.owl-carousel').owlCarousel({
 ...
 $( "#owl-demo .owl-prev").html('<img src="images/prev-services.png">');
 $( "#owl-demo .owl-next").html('<img src="images/next-services.png">');
});
$(function(){
